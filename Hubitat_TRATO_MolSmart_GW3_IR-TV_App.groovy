/**
 *  MolSmart GW3-IR para TV App for Hubitat
 *
 *  Copyright 2024 VH
 *
...
definition(
    name: "MolSmart GW3-IR TV App ",
    namespace: "TRATO",
    author: "VH",
    description: "MolSmart GW3-IR para TV para Hubitat",
...
def initialize() {
    ...
    for(int i = 1; i<=inputCount; i++) {
	    ...
	    if(!contactDev) contactDev = addChildDevice("TRATO", "MolSmart GW3 - IR - TV", contactName, null, [name: "MolSmGW3 IR " + Integer.toString(i), inputNumber: thisName])
